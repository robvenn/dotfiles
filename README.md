...
- **Git ecosystem**: [delta](https://github.com/dandavison/delta), [diffnav](https://github.com/dlvhdr/diffnav), [difftastic](https://github.com/Wilfred/difftastic), [mergiraf](https://mergiraf.org/)
